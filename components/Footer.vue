<template>
  <footer class="footer text-white flex flex-col md:flex-row p-12">
    ...
    <div class="mt-16 w-full md:w-4/12 md:mt-0 md:px-12">
      ...
      <ul>
        <li class="mb-2">
          <a href="https://www.facebook.com/ICI-Cl%C3%ADnica-Dental-101179715574678">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-facebook text-white inline" viewBox="0 0 16 16">
        ...
        <li class="mb-2">
          <a href="https://www.instagram.com/iciclinicadental/">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-instagram text-white inline" viewBox="0 0 16 16">
